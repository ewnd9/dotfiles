...
globalkeys = awful.util.table.join(
  ...
  awful.key({ modkey }, "t", function (c) awful.spawn(home .. "/dotfiles/scripts/gnome-terminal-tmux.sh") end),
  awful.key({ modkey }, "b", function (c) awful.spawn(home .. "/dotfiles/scripts/open-selection.sh") end),
